...
- **Toggle Light/Dark**: switch para alternar entre tema oscuro (por defecto) y tema claro, con la preferencia guardada en `localStorage`.
...
Aporta el aspecto visual con estética _retro arcade_: tipografía monoespaciada para los marcadores y _backdrop blur_ en los overlays. Los colores se definen como variables CSS en `:root` (tema oscuro por defecto); el selector `:root[data-theme="light"]` sobreescribe esas variables para el tema claro.
